...
const EmailTemplates: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    // Click-through flow: ensure only one active template per type
  ...
  const triggerEmail = async (templateId: number, mode: "test" | "invoice" | "confirmation") => {
    ...
    try {
      ...
      alert(`✅ ${mode} email sent successfully!`);
    } catch (err: any) {
            ...
            {t.banner_url && (
              <img
                src={
                  supabase.storage
                    .from("email-banners")
                    .getPublicUrl(t.banner_url).data.publicUrl
                }
                alt="Banner"
              ...
              {editing.banner_url && (
                <img
                  src={
                    supabase.storage
                      .from("email-banners")
                      .getPublicUrl(editing.banner_url).data.publicUrl
                  }
                  alt="Banner"
